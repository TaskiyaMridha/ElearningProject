...
?>
    ...
    <div class="container mt-5">
        ...
        <!-- End most popular course 1st Card Desk -->
...
<!-- End contact us -->
    ...
    <div class="rev-section">
        ...
        <p class="note">Here Is The Valuable Reviews From Our Students</p>

        <div class="reviews">

            <div class="review">
                <div class="head-review">
                    <img src="image/stu/T.jpg" width="250px">
                </div>
                <div class="body-review">
                    <div class="name-review">Taskiya Mridha</div>
                    <div class="place-review">Awesome</div>
                    <div class="rating">
            ...
            <div class="review">
                <div class="head-review">
                    <img src="image/stu/R.jpg" width="250px">
                </div>
                <div class="body-review">
                    <div class="name-review">Jui Dhar</div>
                    <div class="place-review">Nice</div>
                    <div class="rating">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
            ...
            <div class="review">
                <div class="head-review">
                    <img src="image/stu/b.jpg" width="250px">
                </div>
                <div class="body-review">
                    <div class="name-review">Nafis Khan</div>
                    <div class="place-review">Amazing</div>
                    <div class="rating">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
        ...
        <div class="container" style="background-color: #E9ECEF">
            <div class="row text-center">
                <div class="col-sm">
                    <h5>About Us</h5>
                    <p>
                        SmartSchool provides universal access to the world's best education, partnering with top universities and organizations to offer courses online.
                    </p>
                </div>
                ...
                <div class="col-sm">
                    <h5>Contact Us</h5>
                    <P>SmartSchool Pvt Ltd <br> Near Rose View, Uposhohor, Sylhet <br>
                        ph. 0171849164</P>
                </div>
            </div>
        </div>
